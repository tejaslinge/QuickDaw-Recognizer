...
def main():
    ...
    dataset1 = customDatasetClass(path=r'C:/Users/tejas/downloads/g_data/GoogleDataImages_train')
    
      # Get the train dataset
    dataset2 = customDatasetClass(path=r'C:/Users/tejas/downloads/g_data/GoogleDataImages_test') 
    ...
    torch.onnx.export(model,dummy_input,"3epochs.onnx",verbose=True,input_names=['data'],output_names=['output'])
